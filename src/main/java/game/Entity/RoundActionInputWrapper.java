...
public class RoundActionInputWrapper {
    ...
    public List<RobotActionDetail> getActions0() {
        return actions0;
    }

    public void setActions0(List<RobotActionDetail> actions0) {
    ...
    public List<RobotActionDetail> getActions1() {
        return actions1;
    }

    public void setActions1(List<RobotActionDetail> actions1) {
    ...
    public List<RobotActionDetail> getActions2() {
        return actions2;
    }

    public void setActions2(List<RobotActionDetail> actions2) {
    ...
    public List<RobotActionDetail> getActions3() {
        return actions3;
    }

    public void setActions3(List<RobotActionDetail> actions3) {
    ...
    public List<RobotActionDetail> getActions4() {
        return actions4;
    }
